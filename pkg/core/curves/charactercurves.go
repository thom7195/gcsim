...
var CharBaseMap = map[keys.Char]CharBase{
	...
	keys.Aloy: {
		...
		Region:      info.ZoneUnknown,
		WeaponClass: info.WeaponClassBow,
		HPCurve:     GROW_CURVE_HP_S5,
		AtkCurve:    GROW_CURVE_ATTACK_S5,
		DefCurve:    GROW_CURVE_HP_S5,
	...
	keys.Candace: {
		...
		Element:     attributes.Hydro,
		Region:      info.ZoneSumeru,
		WeaponClass: info.WeaponClassSpear,
		HPCurve:     GROW_CURVE_HP_S4,
		AtkCurve:    GROW_CURVE_ATTACK_S4,
		DefCurve:    GROW_CURVE_HP_S4,
		BaseHP:      911.791015625,
	...
	keys.Dehya: {
		...
		PromotionBonus: []PromoData{
			...
			},
			{
				...
				Atk:      17.719818115234375,
				Def:      41.91210174560547,
				Special:  0,
			},
			{
				MaxLevel: 50,
				HP:       1789.64453125,
				Atk:      30.31021499633789,
				Def:      71.6917495727539,
				Special:  0.07199999690055847,
			},
			{
				MaxLevel: 60,
			...
			},
			{
				...
				Atk:      59.687808990478516,
				Def:      141.17759704589844,
				Special:  0.14399999380111694,
			},
			{
				MaxLevel: 80,
				HP:       4267.61376953125,
				Atk:      72.27820587158203,
				Def:      170.95724487304688,
				Special:  0.2160000056028366,
			},
			{
				MaxLevel: 90,
				HP:       5011.00439453125,
				Atk:      84.86859893798828,
				Def:      200.7368927001953,
				Special:  0.2879999876022339,
			},
		},
	},
	...
	keys.Freminet: {
		...
		PromotionBonus: []PromoData{
			...
			},
			{
				MaxLevel: 40,
				HP:       756.08154296875,
				Atk:      15.964559555053711,
				Def:      44.3745002746582,
				Special:  0,
			},
			{
				MaxLevel: 50,
				HP:       1293.29736328125,
				Atk:      27.30780029296875,
				Def:      75.90374755859375,
				Special:  0.05999999865889549,
			},
			{
				MaxLevel: 60,
				HP:       2009.585205078125,
				Atk:      42.43212127685547,
				Def:      117.9427490234375,
				Special:  0.11999999731779099,
			},
			{
				MaxLevel: 70,
				HP:       2546.801025390625,
				Atk:      53.775360107421875,
				Def:      149.4720001220703,
				Special:  0.11999999731779099,
			},
			{
				MaxLevel: 80,
				HP:       3084.016845703125,
				Atk:      65.11859893798828,
				Def:      181.00125122070312,
				Special:  0.18000000715255737,
			},
			{
				MaxLevel: 90,
				HP:       3621.232666015625,
				Atk:      76.46183776855469,
				Def:      212.53050231933594,
				Special:  0.23999999463558197,
			},
		},
	},
	...
	keys.Kirara: {
		...
		PromotionBonus: []PromoData{
			...
			{
				MaxLevel: 40,
				HP:       762.8931274414062,
				Atk:      13.968990325927734,
				Def:      34.20000076293945,
				Special:  0,
			},
			{
				MaxLevel: 50,
			...
			{
				MaxLevel: 60,
				HP:       2027.6895751953125,
				Atk:      37.12810516357422,
				Def:      90.9000015258789,
				Special:  0.11999999731779099,
			},
			{
				MaxLevel: 70,
	...
	keys.Lyney: {
		...
		PromotionBonus: []PromoData{
			...
			{
				MaxLevel: 40,
				HP:       735.6471557617188,
				Atk:      21.231853485107422,
				Def:      35.90999984741211,
				Special:  0,
			},
			{
				MaxLevel: 50,
				HP:       1258.34375,
				Atk:      36.31764602661133,
				Def:      61.42499923706055,
				Special:  0.04800000041723251,
			},
			{
				MaxLevel: 60,
				HP:       1955.2725830078125,
				Atk:      56.43203353881836,
				Def:      95.44499969482422,
				Special:  0.09600000083446503,
			},
			{
			...
			},
			{
				MaxLevel: 80,
				HP:       3000.666015625,
				Atk:      86.6036148071289,
				Def:      146.47500610351562,
				Special:  0.14399999380111694,
			},
			{
				MaxLevel: 90,
				HP:       3523.362548828125,
				Atk:      101.68940734863281,
				Def:      171.99000549316406,
				Special:  0.19200000166893005,
			},
		},
	...
	keys.Neuvillette: {
		...
		PromotionBonus: []PromoData{
			...
			},
			{
				MaxLevel: 40,
				HP:       980.8628540039062,
				Atk:      13.904470443725586,
				Def:      38.474998474121094,
				Special:  0,
			},
			{
				MaxLevel: 50,
				HP:       1677.791748046875,
				Atk:      23.78396224975586,
				Def:      65.8125,
				Special:  0.09600000083446503,
			},
			{
				MaxLevel: 60,
				HP:       2607.0302734375,
				Atk:      36.95661544799805,
				Def:      102.26249694824219,
				Special:  0.19200000166893005,
			},
			{
				MaxLevel: 70,
				HP:       3303.958984375,
				Atk:      46.83610916137695,
				Def:      129.60000610351562,
				Special:  0.19200000166893005,
			},
			{
				MaxLevel: 80,
				HP:       4000.887939453125,
				Atk:      56.71560287475586,
				Def:      156.9375,
				Special:  0.2879999876022339,
			},
			{
				MaxLevel: 90,
				HP:       4697.81689453125,
				Atk:      66.5950927734375,
				Def:      184.27499389648438,
				Special:  0.3840000033378601,
			},
		},
	},
	keys.Furina: {
		...
		PromotionBonus: []PromoData{
			...
			{
				MaxLevel: 40,
				HP:       1021.7321166992188,
				Atk:      16.2830753326416,
				Def:      46.42649841308594,
				Special:  0,
			},
			{
				MaxLevel: 50,
				HP:       1747.69970703125,
				Atk:      27.852630615234375,
				Def:      79.41374969482422,
				Special:  0.04800000041723251,
			},
			{
				MaxLevel: 60,
				HP:       2715.656494140625,
				Atk:      43.27870178222656,
				Def:      123.3967514038086,
				Special:  0.09600000083446503,
			},
			{
				MaxLevel: 70,
